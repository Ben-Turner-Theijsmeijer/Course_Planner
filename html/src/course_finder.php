...
<body class="bg-gray-100 py-8 pt-36">
  <div class="container mx-auto p-4 bg-white shadow-lg rounded-lg">
    ...
    <form id="course-form" class="flex mb-4">
      <input type="text" id="course-code" placeholder="Enter Course Code (i.e CIS*1300 or CIS1300)"
        class="w-1/2 p-2 rounded-lg border border-gray-300 mr-4" />
      <button type="button" id="add-course" class="w-1/2 bg-blue-500 text-white p-2 rounded-lg ml-4">Add
        Course</button>
    </form>
  ...
  <div class="container mx-auto p-4 bg-white shadow-lg rounded-lg mt-12">
