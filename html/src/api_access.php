                        ...
                        <div class="flex flex-col md:flex-row">
                                ...
                                <div class="max-w-md mx-auto rounded-lg p-8 mx-16 text-center">
                                    ...
                                    <!-- <form action="" method="POST" id="requestform"> -->
                                        ...
                                        <div class="flex items-center justify-center">
                                            <button  id="sendRequest" name="sendRequest" class="bg-[#FFC72A] py-2 px-10 mt-2 font-bold rounded-md group transition duration-300">Submit
                            ...
                            <div class="w-full md:w-1/2 md:pl-8 text-xl pt-14">
                                <div class="text-center">
                                    <a href="../api.yml" download class="bg-[#FFC72A] hover:bg-[#C20430] transition duration-300 text-black w-1/6 px-7 py-2 mt-4 mb-2 rounded font-bold">Download api.yml file</a>
                                    <!-- <form action="" method="POST" id="">
