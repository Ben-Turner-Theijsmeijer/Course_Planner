...
<body class="bg-black bg-no-repeat bg-cover bg-top bg-[url('../imgs/background.png')]">
                ...
                <div class="mb-8">
                    ...
                    <div class="flex justify-between w-full">
                        ...
                        <form action="" method="POST" id="">
                            <input type="submit" name="reset" value="Hard Reset Database"
                                ...
                                class="cursor-pointer button border border-[#FFC72A] hover:border-[#C20430] transition duration-300 hover:bg-[#C20430] text-white  px-8 py-2 mb-2 rounded-md font-bold" />
                        </form>
                    </div>
                    ...
                    <div class="flex flex-col gap-14 md:flex-row">
                        ...
                        <div class="w-full md:w-1/2 text-xl pt-14 text-center">
                            ...
                            <h3
                                class="text-2xl font-semibold underline decoration-[#C20430] whitespace-nowrap text-white mb-4">
                                API Commands for Courses Table</h3>
                            <select name="method" id="method" class="rounded px-2 py-1 mb-4 border border-gray-400"
                                required>
                        ...
                        <div class="w-full md:w-1/2 text-xl pt-14 text-center">
                            ...
                            <h3 class="text-2xl font-semibold underline decoration-[#C20430] text-white mb-4">API
                                Commands for Student Table</h3>
                            <select name="requestType" id="requestType"
                                class="rounded px-2 py-1 mb-4 border border-gray-400" required>
                                <option value="" disabled selected>Request Method</option>
                                <option value="GET">GET</option>
                                <option value="PUT">PUT</option>
                                <option value="POST">POST</option>
                        ...
                        <div class="w-full md:w-1/2 text-xl pt-14 text-center">
                            <!-- student command selection & submission section -->
                            <h3 class="text-2xl font-semibold underline decoration-[#C20430] text-white mb-4">API
                                Commands for Subjects</h3>
                            <select name="endpointType" id="endpointType"
                                class="rounded px-2 py-1 mb-4 border border-gray-400" selected="All" required>
                            ...
                            <div class="mb-4 " id="subjectCodeBox" style="display: none;">
                                <label for="command" class="block text-white text-sm font-medium mb-2">Subject
                                    Code</label>
                            ...
                            <!-- student submit button -->
                            <button id="SubjectRequest" name="SubjectRequest"
                                class="bg-[#FFC72A] py-2 px-10 mt-2 font-bold rounded-md group transition duration-300">
                                Submit
                                <span
                                    class="block max-w-0 group-hover:max-w-full transition-all duration-300 h-1 bg-[#C20430]"></span>
    ...
    <div
        class="flex w-auto flex-col mx-72 bg-hero box-content bg-black/60 backdrop-blur-sm bg-no-repeat bg-cover md:rounded-md">
