...
<body class="bg-black bg-no-repeat bg-cover bg-top bg-[url('../imgs/background.png')]">
            ...
            <div class="container mx-auto py-8">
                ...
                <div>
                    ...
                    <div class="flex flex-col md:flex-row mt-8">
                        ...
                        <div class="w-full md:w-1/2 md:pl-8 text-xl">
                            <h2 class="text-xl underline decoration-[#C20430] text-white font-semibold mb-2">Possible Future Courses</h2>
                            <p class="text-white">
                    ...
                    <div class="flex flex-col md:flex-row mt-8">
                        ...
                        <div class="w-full md:w-1/2 md:pl-8 text-xl">
                            <h2 class="text-xl underline decoration-[#C20430] text-white font-semibold mb-2">Next Semester Courses</h2>
                            <p class="text-white">
    ...
    <div class="container mx-auto text-center mt-8">
        ...
        <a href="/excel/course_selection_tool.xlsm" class="inline-block group bg-[#FFC72A] hover:bg-[#C20430] text-xl text-black font-bold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 mb-12" download="course_selection.xlsm">
            Download
        </a>
    </div>
