...
<div class="flex flex-col w-screen h-fill bg-hero bg-no-repeat bg-cover bg-top bg-[url('../imgs/background.png')]">
    <header class="bg-black w-screen">
        <div class="flex flex-row">
            <div class="flex flex-row w-1/2 bg-black h-20 items-center py-6 px-10">
                <span class="font-sans font-bold text-white text-4xl leading-10 underline decoration-[#FFC72A] decoration-4 underline-offset-4">Course Selector</span>
            </div>
    ...
    <content class="flex w-fill h-screen flex-col mx-10 my-10 px-10 py-10 bg-hero bg-black bg-opacity-50 bg-no-repeat bg-cover bg-center bg-fixed rounded-md">
        <span class="font-sans font-bold text-white text-4xl underline decoration-[#FFC72A] decoration-4 underline-offset-4">Meet The Team</span>
