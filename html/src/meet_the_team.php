            ...
            <div class="p-4 max-w-md max-h-md">
                <div class="flex rounded-lg h-full bg-[#C20430] bg-opacity-75 p-8 flex-col">
                    <div class="flex items-center flex-col">
                        ...
                        <div class="rounded-full w-24 h-24 overflow-hidden mb-4">
                            <img src="../imgs/profiles/ben_profile.JPG" alt="Ben's Profile Picture" class="w-full h-full object-cover" />
                        </div>
                    </div>
                    <div class="flex flex-col justify-between flex-grow">
                        <p class="leading-relaxed text-base text-white mb-4">
                            ...
                            <a class="text-blue-500 font-bold" target="_blank" href="https://www.instagram.com/phen.ori/">Working on my latest art project</a>
            ...
            <div class="p-4 max-w-md max-h-md">
                <div class="flex rounded-lg h-full bg-[#C20430] bg-opacity-75 p-8 flex-col">
                    <div class="flex items-center flex-col">
                        ...
                        <div class="rounded-full w-24 h-24 overflow-hidden mb-4">
                            <img src="../imgs/profiles/ethan_profile.jpg" alt="Ethan's Profile Picture" class="w-full h-full object-cover" />
                        </div>
                    </div>
                    <div class="flex flex-col justify-between flex-grow">
                        <p class="leading-relaxed text-base text-white mb-4">
