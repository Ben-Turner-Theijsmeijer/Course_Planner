        ...
        <div class="container mx-auto flex items-center justify-center">
            <div class="w-full md:w-1/3 flex items-center justify-center">
                <div class="rounded-full overflow-hidden">
                    <img src="/src/members/andrew/photos/hero.jpg" alt="Hero Picture"
        ...
        <div class="container mx-auto text-center">
            ...
            <form action="" method="post" class="mt-4">
                ...
                <div class="mb-4">
                    ...
                    <select name="to_currency" id="to_currency" class="rounded px-2 py-1 border border-gray-400"
                        required>
                        <option value="" disabled selected>Select Currency</option>
                        <option value="CAD">CAD - Canadian Dollar</option>
                        <option value="USD">USD - United States Dollar</option>
                ...
                <button type="submit"
                    class="bg-[#FFC72A] hover:bg-yellow-300 text-black px-8 py-2 mt-4 mb-6 rounded font-bold">Convert</button>
            </form>
