...
<body class="bg-black bg-no-repeat bg-cover bg-top bg-[url('../../../imgs/background.png')]">
    ...
    echo generateNav('member', 'Vrushang');
    ?>

    <!-- Content  -->
    <content class="flex w-auto flex-col md:mb-10 md:mt-44 md:mx-10 md:p-10 bg-hero box-content bg-black/60 backdrop-blur-sm bg-no-repeat bg-cover bg-center bg-fixed md:rounded-md">
