    ...
    <div class="flex flex-row">
        <div class="flex flex-row w-1/2 bg-black h-20 items-center py-6 px-10">
            <a href="../../meet_the_team.php">
                <span
                    class="font-sans font-bold text-white text-4xl leading-10 underline decoration-[#FFC72A] decoration-4 underline-offset-4">Ethan
                </span>
            </a>
        </div>
...
<body>
    ...
    <section class="content">
        ...
        <div class="w-full max-w-xs">
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="post" attribute="post"
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        type=number id="operand1" name="operand1" value=0>
                </div>
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            type=number id="operand2" name="operand2" value=0>
                    </div>
                    <button
                        class="bg-[#FFC72A] hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
