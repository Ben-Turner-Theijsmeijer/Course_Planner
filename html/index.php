...
<header class="bg-black w-screen">
    <div class="flex flex-row">
        <div class="flex flex-row w-1/2 bg-black h-20 items-center py-6 px-10">
            <a href="/">
                <span class="font-sans font-bold text-white text-4xl leading-10 underline decoration-yellow-400 decoration-4 underline-offset-4">Course
                    Selector</span>
            </a>
...
<div class="flex flex-col w-screen h-full bg-hero bg-no-repeat bg-cover bg-top bg-[url('imgs/background.png')]">
    <content class="flex items-center justify-center h-screen mx-20 my-20 bg-hero bg-black bg-opacity-50 bg-no-repeat bg-cover bg-center bg-fixed rounded-md backdrop-blur-sm">
        <div class="max-w-4xl mx-auto p-10 text-center flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-6">
            <div class="md:w-1/2 text-white p-4">
                ...
                <span class="block font-sans font-bold text-5xl text-left underline decoration-[#FFC72A] decoration-4 underline-offset-2">Course
                    Selector</span>
            </div>
        ...
        <div class="max-w-md mx-auto rounded-lg shadow-md p-8 mb-32">
            ...
            <form action="https://formspree.io/f/meqnpqdw" method="POST" id="contactForm">
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-400" required>
                </div>
                <div class="mb-4">
                    <label for="email" class="block text-white text-sm font-medium mb-2">Email</label>
                    <input type="email" id="email" name="email" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-400" required>
                </div>
                <div class="mb-6">
                    <label for="message" class="block text-white text-sm font-medium mb-2">Message</label>
                    <textarea id="message" name="message" rows="4" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-400" required></textarea>
                </div>
                <div class="flex items-center justify-center">
                    <button type="submit" id="submitButton" class="bg-blue-500 text-white py-2 px-6 rounded-lg hover:bg-blue-600 transition duration-300">Submit</button>
                </div>
