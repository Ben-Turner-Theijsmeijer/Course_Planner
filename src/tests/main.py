...
from ..src.utils.text_parser import read_course

def test_case1_base():
    # ARRANGE
    course_list = {}
    test_file = open("test_files/test_case1_base.txt")
    expected_course = {
...
def test_case2_restriction():
    # ARRANGE
    course_list = {}
    test_file = open("test_files/test_case2_restriction.txt")
    expected_course = {
        "title": "Programming",
        "offered": "Fall",  
        "credit_weight": "0.50",
...
def test_case3_prereq():
    # ARRANGE
    course_list = {}
    test_file = open("test_files/test_case3_prereq.txt")
    expected_course = {
...
def test_case4_offered():
    # ARRANGE
    course_list = {}
    test_file = open("test_files/test_case4_offered.txt")
    expected_course = {
...
def test_case5_equates():
    # ARRANGE
    course_list = {}
    test_file = open("test_files/test_case5_equates.txt")
    expected_course = {
...
def test_case6_coreq():
    # ARRANGE
    course_list = {}
    test_file = open("test_files/test_case6_coreq.txt")
    expected_course = {
