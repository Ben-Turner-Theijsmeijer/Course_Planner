...
def read_course(file1, course_list):
    ...
    i = 0
    semesters = ["Summer", "Summer,", "Fall",
                  "Fall,", "Winter", "Winter,", "Unspecified"]
        ...
        for word in line.split():
            ...
            if (is_course_code == 2 and (i == course_code_line or i == course_code_line+1)):
                ...
                if title_done == 0:
                    ...
                    if word in semesters or re.search(credit_pattern, word) or word.startswith("(LEC:"):
                        title_done = 1
                ...
                if word in semesters:
                    if offered == "N/A":
                        ...
                        if word.endswith(','):
                            offered = offered + ", " + word[:-1]
                        else:
                            offered = offered + ", " + word
            ...
            if "(s):" not in word:
                ...
                # Formats
                if is_format == 1:
                    if delivery_format == "N/A":
                        delivery_format = word
                    else:
                        delivery_format = delivery_format + " " + word
                ...
                if is_prerequisites == 1:
                    ...
                    # For Course Prerequisites
                        ...
                        if prerequisites[0] == "N/A":
                            prerequisites[0] = word
                        else:
                ...
                if is_corequisites == 1:
                    ...
                    # other cases
                        ...
                        if word.endswith(','):
                            corequisites[0] = word[:-1]
                        else:
                            corequisites[0] = word
                    else:
                        if word.endswith(','):
                            corequisites.append(word[:-1])
                        else:
                            corequisites.append(word)
                    prev_word = word
